...
export const getFeedCardStyles = (theme) => StyleSheet.create({
  card: {
    ...
    borderWidth: 0,
    minHeight: theme.spacing.sizes.farm.feedCardHeight,
  ...
  metaRow: {
    ...
    marginTop: theme.spacing.component.card.gapSmall,
  },
  metaItem: {
    flex: 1,
